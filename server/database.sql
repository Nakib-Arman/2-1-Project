...
(
    ...
    LIBRARY_PASSWORD TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS REQUEST_BOOK_RELATION (
    USER_REQUEST_ID INT NOT NULL,
    BOOK_ID INT NOT NULL,
    REQUEST_STATUS VARCHAR(20) DEFAULT 'Pending' CHECK (REQUEST_STATUS IN ('Pending','Accepted','Rejected','Returned')),
...
CREATE TABLE BOOK_SEARCHED(
	SEARCHED_INDEX SERIAL PRIMARY KEY,
	USER_ID INT NOT NULL CHECK (USER_ID>0),
	BOOK_ID INT NOT NULL CHECK (USER_ID>0),
